...
- **A Side Notch when the menu bar is not enough.** An opt-in Alpha handle lives at the right
  screen edge, expanding into provider rings on hover without taking keyboard focus.
...
can open Settings directly, restore the menu bar item, refresh readings, or quit the app.
...
**Settings → General → Side Notch · Alpha** adds the same readings as a second, optional surface: a
...
<p align="center">
  <img src="docs/images/settings-notifications.png" width="700" alt="Settings → Notifications: compact independent reminder summaries with options opened for one window">
</p>
